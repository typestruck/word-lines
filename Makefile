...
watch:
	ghciwatch --after-startup-ghci :main --after-reload-ghci :main  --debounce 50ms --watch public/static/styles.css --watch Client/Game.hs --watch Shared/Game/View.hs --command 'wasm32-wasi-cabal repl client -finteractive --repl-options="-fghci-browser -fghci-browser-port=8080"'
...
update-js:
	cabal update client --with-ghc=javascript-unknown-ghcjs-ghc --with-hc-pkg=javascript-unknown-ghcjs-ghc-pkg

build-js:
	cabal build client --with-ghc=javascript-unknown-ghcjs-ghc --with-hc-pkg=javascript-unknown-ghcjs-ghc-pkg
