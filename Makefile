...
watch:
	ghciwatch --after-startup-ghci :main --after-reload-ghci :main  --debounce 50ms --watch app/Main.hs --watch app/Letters.hs --watch app/Styles.hs --watch app/Dictionary.hs --command 'wasm32-wasi-cabal repl app -finteractive --repl-options="-fghci-browser -fghci-browser-port=8080"'
